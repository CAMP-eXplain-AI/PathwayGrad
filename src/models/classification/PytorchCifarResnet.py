...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, strides=[1, 2, 2, 2]):
...
def ResNet8():
    return ResNet(BasicBlock, [1, 1, 1], strides=[1, 2, 2])


def ResNet8v2():
    return ResNet(BasicBlock, [1, 1, 1], strides=[1, 1, 2])
